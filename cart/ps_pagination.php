...
class PS_Pagination {
	...
	function renderFirst($tag='First') {
		if($this->page == 1) {
			...
			return '<a href="'.$this->php_self.'?op=shop&page=1">'.$tag.'</a>';
		}
	}
	...
	function renderLast($tag='Last') {
		if($this->page == $this->max_pages) {
			...
			return '<a href="'.$this->php_self.'?op=shop&page='.$this->max_pages.'">'.$tag.'</a>';
		}
	}
	...
	function renderNext($tag=' &gt;&gt;') {
		if($this->page < $this->max_pages) {
			return '<a href="'.$this->php_self.'?op=shop&page='.($this->page+1).'">'.$tag.'</a>';
		}
		else {
			return $tag;
		}
	...
	function renderNav() {
		...
		for( $i=$start ; $i<$end ; $i++) {
			if($i == $this->page) {
				...
				$links .= ' <a href="'.$this->php_self.'?op=shop&page='.$i.'">'.$i.'</a> ';
			}
		}
